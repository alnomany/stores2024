...
function extras_fields(name, price) {
  ...
  divtest.innerHTML =
    '<div class="row m-0 variations"><div class="col-md-6"><div class="form-group"><input type="text" class="form-control" name="extras_name[]" placeholder="' +
    name +
    '" required></div></div><div class="col-md-6"><div class="form-group"><div class="d-flex"><input type="text" class="form-control numbers_only" name="extras_price[]" placeholder="' +
    price +
    '" required><button class="btn btn-outline-danger mx-2" type="button" onclick="remove_extras_fields(' +
    extras_row +
...
function edititem_fields(
  ...
  editdivtest.innerHTML =
    ...
    ']" placeholder="' +
    max_order +
    '" ><button class="btn btn-outline-danger mx-2" type="button" onclick="remove_edit_fields(' +
    editroom +
    ');"><i class="fa-sharp fa-solid fa-xmark"></i></button></div></div></div></div></div>';
...
function more_editextras_fields(name, price) {
  ...
  editroom++;
  var editdivtest = document.createElement("div");
  editdivtest.setAttribute("class", "row m-0 editextrasclass" + editroom);
  editdivtest.innerHTML =
    ...
    '" required></div></div><div class="col-md-6"><div class="form-group"><div class="d-flex"><input type="text" class="form-control numbers_only" name="extras_price[]" placeholder="' +
    price +
    '" required><button class="btn btn-outline-danger mx-2" type="button" onclick="remove_editextras_fields(' +
    editroom +
    ');"><i class="fa-sharp fa-solid fa-xmark"></i></button></div></div></div>';
        ...
        for (i in response.responsdata) {
          {
            extras_row++;
            html +=
              '<div class="row m-0 removeextras' +
              extras_row +
              '"><div class="col-md-6 form-group"><input type="text" class="form-control" name="extras_name[]" value="' +
              response.responsdata[i].name +
              '" placeholder="' +
              placehodername +
              '"></div><div class="col-md-6"><div class="d-flex"><input type="text" class="form-control" value="' +
              response.responsdata[i].price +
              '" name="extras_price[]" placeholder="' +
              placeholderprice +
              '"><button class="btn btn-outline-danger mx-2" type="button" onclick="remove_extras_fields(' +
              extras_row +
              ');"><i class="fa-sharp fa-solid fa-xmark"></i></button></div></div></div>';
          }
