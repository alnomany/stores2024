...
$("#addfeature").click(function() {
    "use strict";
    var html =
        '<div class="d-flex my-2" id="removediv-' + i +
        '"><input type="text" class="form-control" name="plan_features[]" value="" placeholder=""><button type="button" class="btn btn-danger mx-2 btn-sm" onclick="removefeature(' +
