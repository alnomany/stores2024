...
class RecaptchaV3
{
    ...
    {
        $this->secret = helper::appdata('')->google_recaptcha_secret_key;
        $this->sitekey = helper::appdata('')->google_recaptcha_site_key;
    ...
    {
        return helper::appdata('')->google_recaptcha_site_key;
    }
