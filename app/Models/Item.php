...
class Item extends Model
{
    ...
    public function product_image(){
        return $this->hasOne('App\Models\ProductImage','item_id','id')->select('*',\DB::raw("CONCAT('".url('/storage/app/public/item/')."/', image) AS image_url"));
    }
    public function multi_image(){
        return $this->hasMany('App\Models\ProductImage','item_id','id')->select('*',\DB::raw("CONCAT('".url('/storage/app/public/item/')."/', image) AS image_url"))->orderBy('id');
    }
