...
class GlobalExtrasController extends Controller
{
    public function index(Request $request)
    {
        ...
        $allextras  = GlobalExtras ::where('vendor_id', $vendor_id)->where('is_deleted',2)->orderBy('reorder_id')->get();
    ...
    public function getextras(Request $request)
    {
        ...
        $globalextras = GlobalExtras::where('vendor_id',$vendor_id)->where('is_available',1)->where('is_deleted',2)->get();
