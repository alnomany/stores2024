...
<section class="breadcrumb-sec">
    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb">
            ...
            <h2 class="breadcrumb-title mb-2">{{ trans('labels.delete_profile') }}</h2>
        ...
        <div class="user-bg-color mb-5">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-8 col-xxl-9 col-12 deleteprofile">

                        <div class="card border">
                            <div class="settings-box-header border-bottom px-4 py-3">
                                <h5 class="text-dark m-0 profile-title"><i class="fa-light fa-trash"></i><span
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <a href="#"
                                        class="col-12 col-md-4 col-xl-3 btn btn-store mb-3 mb-md-0 me-2">Keep
                                        my account</a>
                                    <a onclick="deleteaccount('{{ URL::to($storeinfo->slug . '/deleteaccount/') }}')" 
                                        class="col-12 col-md-4 col-xl-3 btn btn-store bg-danger btn-delete"> {{ trans('labels.delete_profile') }}
                                    </a>
                                </div>
                            </div>
                            <!-- Card body END -->
