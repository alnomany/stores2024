            ...
            @if (Auth::user()->type == 1)
                @if (App\Models\SystemAddons::where('unique_identifier', 'language')->first() != null &&
                    ...
                    <div class="d-inline-flex">
                        <a href="{{ URL::to('/admin/language-settings/add') }}" class="btn btn-secondary px-2 d-flex">
        ...
        @if (Auth::user()->type == 1)
            ...
            <div class="col-xl-9">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="dropdown">
                        <a class="btn btn-outline-info" tooltip="{{ trans('labels.edit') }}"
                            href="{{ URL::to('/admin/language-settings/language/edit-' . $currantLang->id) }}"><i
                                class="fa-regular fa-pen-to-square"></i></a>
                        @if (Strtolower($currantLang->name) != 'english')
                            <a class="btn btn-outline-danger" tooltip="{{ trans('labels.delete') }}"
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <a tooltip="{{ trans('labels.inactive') }}"
                                                        ...
                                                        class="btn btn-sm btn-outline-danger {{ Auth::user()->type == 4 ? (helper::check_access('role_language-settings', Auth::user()->role_id, $vendor_id, 'edit') == 1 ? '' : 'd-none') : '' }}"><i
