                    ...
                    <form action="{{ URL::to('admin/categories/save') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group text-end">
                                ...
                                <button class="btn btn-secondary {{Auth::user()->type == 4 ? (helper::check_access('role_categories', Auth::user()->role_id, $vendor_id, 'add') == 1  ? '':'d-none'): ''}}" @if (env('Environment') == 'sendbox') type="button"
