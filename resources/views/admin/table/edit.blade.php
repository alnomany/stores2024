                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name"
                                    value="{{ $edittable->name }}" placeholder="{{ trans('labels.name') }}" required>
                                @error('name')
                            ...
                            <div class="form-group text-end">
                                ...
                                <button class="btn btn-secondary {{Auth::user()->type == 4 ? (helper::check_access('role_table', Auth::user()->role_id, $vendor_id, 'edit') == 1  ? '':'d-none'): ''}}" @if (env('Environment') == 'sendbox') type="button"
