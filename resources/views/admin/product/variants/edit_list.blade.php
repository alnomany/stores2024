    ...
    <table class="table" id='tblvariants'>
        ...
        <tbody>
            ...
            <tr>
                ...
                @endforeach
                <td>
                    <input type="number" id="voriginal_price_{{ $counter }}" autocomplete="off" spellcheck="false" placeholder="{{ trans('labels.original_price')  }}" class="form-control"
                    name="{{ $name['original_price'] }}" value="{{ $name['original_price_val'] }}" required>
                </td>
                <td>
                    <input type="number" id="vprice_{{ $counter }}" autocomplete="off" spellcheck="false" placeholder="{{ trans('labels.selling_price')  }}" class="form-control"
                    name="{{ $name['price'] }}" value="{{ $name['price_val'] }}" required>
                </td>
               
                <td>
                    <input type="number" id="vqty_{{ $counter }}" autocomplete="off" spellcheck="false" placeholder="{{ trans('labels.stock_qty')  }}" class="form-control"
                    name="{{ $name['qty'] }}" value="{{ $name['qty_val'] }}">
                </td>
                <td>
                    <input type="number" id="vmin_order_{{ $counter }}" autocomplete="off" spellcheck="false" placeholder="{{ trans('labels.min_order_qty')  }}" class="form-control"
                    name="{{ $name['min_order'] }}" value="{{ $name['min_order_val'] }}">
                </td>
                <td>
                    <input type="number" id="vmax_order_{{ $counter }}" autocomplete="off" spellcheck="false" placeholder="{{ trans('labels.max_order_qty') }}" class="form-control"
                    name="{{ $name['max_order'] }}" value="{{ $name['max_order_val'] }}">
                </td>
                <td>
                    <input type="number" id="vlow_qty_{{ $counter }}" autocomplete="off" spellcheck="false" placeholder="{{ trans('labels.low_qty') }}" class="form-control"
                ...
                <td class="text-center">
                    <input type="checkbox" id="{{ $counter }}" class="form-check-input product_available" 
