        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <nav aria-label="breadcrumb">
                ...
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ URL::to('admin/apps') }}">{{ trans('labels.addons_manager') }}</a></li>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ URL::to('admin/systemaddons/store') }}" name="about" id="about" enctype="multipart/form-data">
                            ...
                            <div class="text-end">
                                ...
                                <button type="button" class="btn btn-secondary" onclick="myFunction()">{{ trans('labels.install') }}</button>
                                @else
